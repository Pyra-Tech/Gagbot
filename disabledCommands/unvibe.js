...
const { getChastity, getVibe, removeVibe, canAccessChastity } = require("./../functions/vibefunctions.js");
...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addUserOption((opt) => opt.setName("user").setDescription("Who to remove the vibrator from"))
		.addStringOption((opt) =>
			opt
				.setName("type")
